  ...
  return (
    <section ref={ref} id="certificates" className="relative w-full overflow-hidden py-32 md:py-48">
      <div className="relative mx-auto max-w-[1600px] px-6 md:px-10">
        ...
        <div className="relative mx-auto flex h-[55vh] w-full items-center justify-center md:h-[78vh]">
          <h2
            ref={wordRef}
            className="display pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 whitespace-nowrap text-ink/90 select-none text-[clamp(3rem,18vw,18rem)] md:text-[clamp(4rem,20vw,18rem)] leading-[0.82] z-[1]"
          >
            MASTERY
          </h2>
          <img
